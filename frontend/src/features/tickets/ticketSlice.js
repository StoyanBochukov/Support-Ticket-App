...
export const ticketSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        .addCase(createTicket.rejected, (action, state) => {
            state.isLoading = false
            state.isError = true
        ...
        .addCase(getTickets.rejected, (action, state) => {
            state.isLoading = false
            state.isError = true
            state.message = action.payload
        })
        ...
        .addCase(getTicket.rejected, (action, state) => {
            state.isLoading = false
            state.isError = true
            state.message = action.payload
        })
        .addCase(closeTicket.fulfilled, (action, state) => {
            state.isLoading = false
